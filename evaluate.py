...
def results_to_markdown_table(all_results):
    """Renders all_results as the same markdown table format used in the README,
    so the README's results section can be regenerated by copy/paste."""
    header_names = ["Confidence", "Temp-Scaled", "Energy", "Distance", "MC Dropout", "OOD (SVM)", "Mahalanobis"]
    shift_display = {"blur": "Blur", "noise": "Noise", "brightness_contrast": "Brightness/Contrast",
                      "rotation": "Rotation", "occlusion": "Occlusion", "jpeg": "JPEG"}

    lines = ["| Shift               | " + " | ".join(header_names) + " |",
...
if __name__ == "__main__":
    ...
    # Persist everything needed to reproduce the README results table and plots
